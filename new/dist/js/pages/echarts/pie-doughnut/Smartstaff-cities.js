$(function () {
  ...
  var basicpieChart = echarts.init(document.getElementById("cities-stats"));
  var option = {
    // Add title
    title: {
    ...
    legend: {
      orient: "vertical",
      x: "left",
      data: ["JIG002", "JIG003", "JIG004", "JIG005"],
    },

    // Add custom colors
    color: ["#ffbc34", "#7460ee", "#212529", "#f62d51"],
    ...
    series: [
      {
        ...
        center: ["50%", "57.5%"],
        data: [
          { value: 38, name: "JIG003" },
          { value: 210, name: "JIG005" },
        ],
      },
    ],
  };
