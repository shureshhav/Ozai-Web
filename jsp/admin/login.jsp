        ...
        "
			...
			<div class="auth-box p-4 bg-white rounded">
				<div id="loginform">
					...
					<div class="row">
						<div class="col-12">
							<h4>Not registered yet? <a href="<%=request.getContextPath() %>/admin-register">Register</a></h4>
							<c:if test="${param.success == 'yes' }">
								<div class="toast mb-2 d-flex
	                        		align-items-center text-white bg-success border-0">
							...
							<form method="POST" action="validateAdminLogin"
