        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="text-center">
              <h4 style="font-weight: 800; color: #000;">ROOMS</h4>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 col-12">
                  <c:if test="${not empty rooms }">
                  	<div class="row ">
	                    <c:forEach items="${rooms}" var="room" varStatus="sno">							
							<div class="col-4">
								 <a href="<%=request.getContextPath() %>/admin/properties/edit-room/${room.id}">
									 <div class="card card-body text-center" style="border-radius: 10px; box-shadow: 2px 2px 2px 2px #c7c4d7;">
										<small class="text-muted">${room.property.name }</small>
										<i class="bi bi-door-closed fa-2x text-info"></i>
