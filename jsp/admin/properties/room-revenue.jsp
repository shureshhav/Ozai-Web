        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="text-center">
              <h4 style="font-weight: 800; color: #000;">ROOM WISE REVENUE</h4>
            </div>
              ...
              <div class="">
                <div class="border-bottom title-part-padding text-end">
                  <a class="btn btn-dark btn-sm"
                  	href="<%=request.getContextPath() %>/admin/properties/property-revenue"><i class="fa fa-rupee-sign"></i> VIEW PROPERTY WISE REVENUE</a>
                </div>
                <div class="card-body">
