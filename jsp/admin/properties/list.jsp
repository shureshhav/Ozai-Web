                    	...
                    	<div class="card card-body" style="border-radius: 10px; 
                    		...
                    		<div class="row">
                    			<div class="col-3">
									...
									<hr>
									<a href="<%=request.getContextPath() %>/admin/properties/edit/${pg.id }"
                    					class="btn btn-outline-warning w-100"><i class="fa fa-edit"></i> EDIT</a>
                    			</div>
                    			<div class="col-9">
                    				...
                    				<a href="<%=request.getContextPath() %>/admin/properties/details/${pg.id }"
