              ...
              <div class="card">
                ...
                <div class="card-body row">
                  ...
                  <div class="table-responsive">
                    ...
                    <table id="tenants"
                      class="table table-bordered table-striped table-condensed display text-nowrap">
                      <thead>
                        <!-- start row -->
                        <tr>
                          <th>Name</th>
                      ...
                      <tbody>
                        <!-- start row -->
                        <c:forEach items="${bookings}" var="booking" varStatus="sno">
	                        <tr>
	                          <td>${booking.name }</td>
							  ...
							  <td>${booking.status }/<a href="<%=request.getContextPath() %>/admin/bookings/confirm-bookings/${booking.id }"
