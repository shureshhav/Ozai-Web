        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-5 align-self-center">
              <h4 class="page-title">Add Admin Role</h4>
            </div>
                ...
                <div class="card-body">
                	<c:choose>
                		<c:when test="${AdminUser.access_level eq 1 }">
		                  	<form action="<%=request.getContextPath()%>/admin/registerAdminRoleAction"
										...
										<div class="form-group">
											...
											<select class="form-control form-select"
												...
												<c:forEach items="${pgs }" var="pg">
													<option value="${pg.code }">${pg.name } | ${pg.location } | ${pg.city } | ${pg.client }</option>
												</c:forEach>
											</select>
											<div class="validate"></div>
										</div>
