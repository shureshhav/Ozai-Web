...
<title>Pending Salaries | Ozai Living</title>
<link rel="canonical"
	...
	<div id="main-wrapper">
		...
		<div class="container-fluid">
            ...
            <div class="col-md-12 col-12">
				<h5 class="text-center fw-bold text-dark">Salary Payment</h5>
					<!-- ---------------------
                            start File export
                        ---------------- -->
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-6 col-6 col-12 col-sm-12">
									<form id="month-form"
										action="<%=request.getContextPath()%>/admin/employees/salary-list/month"
					...
					<div class="row">
						<div class="col-12">
						<c:if test="${not empty salaryDue }">
							<h5 class="text-center text-dark fw-bold">DUE</h5>
							<c:forEach items="${salaryDue}" var="rent">
								<div class="card" style="border-radius: 20px;">
									<div class="card-body">
										<div class="row mb-3">
											<div class="col-auto">
												<div class="avatar avatar-44 shadow-sm rounded-10">
													<img src="http://www.ozailiving.com/assets/images/default-user.png"
												...
												<div class="row">
													...
													<div class="col align-self-center ps-0">
														...
														<p class="text-color-theme">
															${rent.service_month } 
															<a href="<%=request.getContextPath() %>/admin/employees/salary/${rent.id }"
						...
						<c:if test="${empty salaryDue }">
							<div class="card card-body text-center">No results found.</div>
						</c:if>
						</div>
					</div>
					...
					<div class="row">
						...
						<c:if test="${not empty salaryPaid }">
							<h5 class="text-center text-dark fw-bold">PAID</h5>
							<table id="tenants2">
								<thead>
								</thead>
								<tbody>
