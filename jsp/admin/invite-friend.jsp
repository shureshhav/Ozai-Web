...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Invite Friend | Ozai Admin</title>
    <link
      rel="canonical"
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card" style="display: none;" id="successScreen">
			...
			<div class="card-text">
				<p>You will get bonus when your friends gets registered.</p>
			</div>
	            ...
	            <div class="col-12">
	              <div class="card" style="padding: 5vh 2vh; width: 100%;">
	                <div class="card-body" style="padding: 0;">
	                	<h4 class="card-title">Invite A Friend</h4>
	                    	...
	                    	<div class=" d-flex align-items-stretch">
								<form action="#" method="post" role="form"
									...
									<div class="row">
										...
										<input type="hidden" name="referred_user" id="referred_user" value="${User.id }" />
...
<!-- All Jquery -->
	...
	function saveEnquiry(){
		...
		$.ajax({
			type : "POST",
			url : "${pageContext.request.contextPath}/referAFriend",
			data : formData,
