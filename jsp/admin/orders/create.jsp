...
<body>
							...
							<div class="card">
								...
								<div class="card-body">
									<form id="order-form"
										action="#" method="post">
										<div class="row">										
											<input type="hidden" name="admin_id" id="admin_id" value="${AdminUser.client_code }" required />
	...
	<script>
		...
		function saveOrder() {
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/admin/saveOrder",
				data : formData,
				...
				success : function(data) {
					...
					if (data == 'success') {
						...
						window.location.href = "${pageContext.request.contextPath}/admin/orders/list";
					} else if (data == 'error') {
						$('#errorMsg').click();
					} else if (data == 'empty') {
						$('#emptyMsg').click();
