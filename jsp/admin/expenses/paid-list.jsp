              ...
              <div class="card">
                ...
                <div class="card-body">
                  <c:if test="${not empty finances }">
                      ...
                      role="tablist">
                      <li class="nav-item">
                    	<a class="nav-link"  href="<%=request.getContextPath() %>/admin/expenses/list">
                          <span>Pending</span>
                        </a>
                      </li>
                    ...
                    <div class="active" id="cleared">
	                  <div class="table-responsive">
	                    <table id="tenants"
	                      class="table customize-table table-borderless mb-0 v-middle no-wrap" style="width: 100%">
	                      <thead>
	                        <!-- start row -->
	                        <tr>
	                          	<th>Code</th>
	                      ...
	                      <tbody id="pulledData">
	                        ...
	                        <c:forEach items="${finances}" var="finance">
	                        	<c:choose>
									<c:when test="${OpsUser.access_level eq 1 || OpsUser.username eq 'nagesh' || OpsUser.username eq 'pruthvi' }">
				                        <tr>
				                          ...
				                          <td><a href="https://tikaana.com/uploaded_files/DOC/EXPENSES/${finance.filename }"
											...
											<td>
												<a
													href="<%=request.getContextPath() %>/ops/expenses/update-payment/${finance.id }"
													class="btn-sm btn btn-success" target="_blank">See</a>
											</td>
