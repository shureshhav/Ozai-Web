							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a
										href="<%=request.getContextPath()%>/ops">Home</a></li>
									...
									<div class="col-md-9 col-9">
										<c:if test="${OpsUser.access_level eq 1 }">
											...
											<c:if test="${expense.status == 'Due' }">
												<div class="row">
													<form
														action="<%=request.getContextPath()%>/ops/addSalaryPayment"
					                            	...
					                            	col-md-3">Payment
																			...
																			<div class="col-md-9">
																				<input type="text" name="paymentId" id="paymentId"
																					class="form-control" value="${paymentId }" />
																			</div>
																		</div>
																	</div>
																	<div class="col-md-12">
					                            	...
					                            	col-md-3">Employ
																			...
																			<div class="col-md-9">
																				<input type="text" name="first_name" id="first_name"
																					class="form-control" value="${employ.first_name }" />
																			</div>
																		</div>
																	</div>
																	<div class="col-md-12">
					                            	...
					                            	col-md-3">Employ
																				Code</label>
																			<div class="col-md-9">
																				<input type="text" name="employ_id" id="employ_id"
																					class="form-control" value="${employ.employ_id }" />
																			</div>
																		</div>
																	</div>
																	<div class="col-md-12">
					                            	...
					                            	col-md-3">Salary
																			...
																			<div class="col-md-9">
																				<input type="month" name="salary_month"
																					id="salary_month" class="form-control"
																					value="${expense.service_month }" />
																	...
																	<div class="col-md-12">
																		<div class="mb-3 row">
																			<label class="control-label text-end col-md-3">Payment
																				Date</label>
																			<div class="col-md-9">
																...
																<div class="row">
																	...
																	<div class="col-md-12">
																		<div class="mb-3 row">
																			<label class="control-label text-end col-md-3">Amount
																				Paid</label>
																			<div class="col-md-9">
																...
																<div class="row">
																	<input type="hidden" name="amount_cleared"
																		id="amount_cleared" value="${totalAmountPaid }" /> <input
																		type="hidden" name="no" id="no" value="${employ.id }" />
																	<input type="hidden" name="expense_code"
																		id="expense_code" value="${expense.expense_code }" />
																	<!--/span-->
																	<div class="col-md-12">
																		<div class="mb-3 row">
																			<label class="control-label text-end col-md-3">Txn
																				Reference No</label>
																			<div class="col-md-9">
																	...
																	<div class="col-md-12">
																		<div class="mb-3 row">
																			<label class="control-label text-end col-md-3">Select
		                    	...
		                    	align-items-center">
											...
											<div class="card-body">
												...
												<div class="row gap-2">
													<div class="col-md-12">
														<a
															href="<%=request.getContextPath()%>/ops/employees/list"
															class="btn d-flex align-items-center
		                          				btn-light-info w-100 d-block text-info font-weight-medium">
															Employ List <span class="badge ms-auto bg-info"><i
					                          ...
					                          text-success font-weight-medium">
															Add Employ <span class="badge ms-auto bg-success"><i
																class="fa fa-plus"></i></span>
														</a>
													</div>
													<div class="col-md-12">
														<a
															href="<%=request.getContextPath()%>/ops/employees/payment-list"
															class="btn d-flex align-items-center
		                          				btn-light-warning w-100 d-block text-warning font-weight-medium">
															Payment List <span class="badge ms-auto bg-warning"><i
																class="fa fa-list"></i></span>
														</a>
													</div>
													<div class="col-md-12">
														<a
															href="<%=request.getContextPath()%>/ops/employees/salary-list"
															class="btn d-flex align-items-center
		                          				btn-light-primary w-100 d-block text-primary font-weight-medium">
															Salary List <span class="badge ms-auto bg-primary"><i
																class="fa fa-list"></i></span>
														</a>
													</div>
												</div>
