...
<body>
			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-5 col-md-5 col-sm-12 col-12 align-self-center">
						<h4 class="page-title">Add an expense</h4>
					</div>
			...
			<div class="container-fluid">
				...
				<div class="col-12">
		            <div class="card">
		             	<div class="card-body">
							<form class="mt-4"
								action="<%=request.getContextPath()%>/admin/savePurchase"
											...
											<div class="form-group">
												<div class="mb-3 controls">
													...
													<input type="text" name="vendor_invoice_no"
														id="vendor_invoice_no" class="form-control" />
												</div>
											</div>
											<div class="form-group">
												<div class="mb-3 controls">
											...
											<div class="form-group">
												<div class="mb-3 controls">
													...
													<input type="text" name="invoice_amount"
														id="invoice_amount" required class="form-control" />
											...
											<div class="form-group">
												<div class="mb-3 controls">
													...
													<input type="date" name="payment_due_date"
														id="payment_due_date" class="form-control" />
												</div>
											</div>
											<!--/span-->
											<div class="form-group">
	...
	<script type="text/javascript">
		...
		$('document').ready(function() {
			$('#select2-language').change(function() {
				if ($('#select2-language').val() == "Other") {
					$('#other_field').show();
					$('#other_vendor').val(null);
				} else {
					$('#other_field').hide();
					$('#other_vendor').val("null");
				}
