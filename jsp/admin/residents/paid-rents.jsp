...
<title>Paid Rents | Ozai Living</title>
<link rel="canonical"
			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-5 col-md-5 col-sm-12 col-12 align-self-center">
						<h4 class="page-title">Paid rents</h4>
					</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-6">
									<form id="month-form"
										action="<%=request.getContextPath()%>/admin/residents/month/paid-rents"
								...
								<div class="col-6">
									<form id="month-form"
										action="<%=request.getContextPath()%>/admin/residents/property/paid-rents"
										role="form" method="post">
										<div class="input-group mb-3">
													...
													<div class="col align-self-center ps-0">
														...
														<p class="text-color-theme">
															...
															<a href="<%=request.getContextPath() %>/admin/residents/update-rent-payment/${rent.id }"
																class="btn btn-sm btn-warning text-white px-2 float-end">VIEW <i class="fas fa-arrow-alt-circle-right"></i></a>
														</p>
