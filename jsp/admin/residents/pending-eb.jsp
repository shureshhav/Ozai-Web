...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Pending Electricity Bills | Tikaana Admin Dashboard for payments</title>
    <link
      rel="canonical"
				...
				<div class="card w-100">
					...
					<div class="card-body">
						...
						<div class="row gap-2">
							...
							<div class="col-md-12">
								<a href="<%=request.getContextPath() %>/admin/residents/sd/pending-payments"
									class="btn d-flex align-items-center
			                          btn-danger w-100 d-block
			                          font-weight-medium">
									Pending SD <span class="badge ms-auto bg-danger"><i class="fa fa-rupee-sign"></i></span>
								</a>
							</div>
							<div class="col-md-12">
								<a href="<%=request.getContextPath() %>/admin/residents/eb/pending-payments"
									class="btn d-flex align-items-center
			                          btn-primary w-100 d-block
			                          font-weight-medium">
									Pending EB <span class="badge ms-auto bg-primary"><i class="fa fa-bolt"></i></span>
								</a>
							</div>
						</div>
					</div>
