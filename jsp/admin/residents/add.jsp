        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
            	<div class="card">
					<div class="card-body">
						<form action="<%=request.getContextPath()%>/admin/getUser" id="user-form"
							method="post" role="form">
							<div class="form-group">
								<label>Mobile/Username</label>
								<input type="text" name="checkMobile" id="checkMobile" class="form-control" />
							</div>
							<div class="row mt-2 form-group">
								<button type="submit" id="save" class="btn btn-rounded btn-primary">SEARCH</button>
							</div>
						</form>
					</div>
				</div>
              <div class="card">
                <div class="card-body">
                  <form action="<%=request.getContextPath()%>/admin/addResidentAction"
            ...
            <div class="col-lg-3 d-flex align-items-stretch d-none d-lg-block">
