			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<form action="#" id="user-form" method="post" role="form">
									<div class="form-group">
										<label>Mobile/Username</label>
										<input type="text" name="mobile" id="mobile" class="form-control" />
									</div>
									<div class="row mt-2 form-group">
										<button type="submit" id="send" class="btn btn-rounded btn-primary">SEARCH</button>
									</div>
								</form>
							</div>
						</div>
						<div class="card card-body" id="pulledData">
							<table class="display">
								<tbody>
									<tr>
										<th>Name</th>
                ...
                ">
						<div class="modal-body p-4">
							<div class="text-center text-success">
								...
								<p class="mt-3 text-success-50">Resident has been added.</p>
