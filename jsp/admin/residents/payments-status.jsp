...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Tikaana Admin Dashboard for payments</title>
    <link
      rel="canonical"
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <%-- <div class="d-flex justify-content-center">
           		...
           		<div class="row">
           			<div class="col-md-6">
						<form id="month-form" action="<%=request.getContextPath() %>/admin/residents/month/pending-payments"
					...
					<%-- <div class="col-md-6">
						<form class="property-form" action="<%=request.getContextPath() %>/admin/tenants/property-payments"
							role="form" method="post">
						...
						<div class="row gap-2">
							<div class="col-md-12">
								<a href="<%=request.getContextPath() %>/admin/residents/list"
									...
									Resident List <span class="badge ms-auto bg-info"><i class="fa fa-list"></i></span>
								</a>
							</div>
							<div class="col-md-12">
