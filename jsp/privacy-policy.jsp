      ...
      <div class="row">
        <div class="text-justify">
						...
						<ul>
							...
							<li>
								<p>
									<strong>Website</strong> refers to OZaiLiving, accessible from <a
										href="https://www.ozailiving.com"
										rel="external nofollow noopener" target="_blank">https://www.ozailiving.com</a>
								</p>
							</li>
							<li>
								<p>
						...
						<p>
							...
							cookies on the <a
								...
								target="_blank">Privacy Policies website</a> article.
						</p>
							...
							<li>
								<p>
									By visiting this page on our website: <a
										href="https://www.ozailiving.com/mobile/support"
										rel="external nofollow noopener" target="_blank">https://www.ozailiving.com/mobile/support</a>
								</p>
							</li>
						</ul>
