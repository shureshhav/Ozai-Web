  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <form action="<%=request.getContextPath()%>/lct/saveEvent" method="post"
                  	enctype="multipart/form-data" id="event-form" modelAttribute="event">
                  <div>
                    <div class="card-body">
						...
						<div class="form-group">
							<div class="mb-3 controls">
								<label class="control-label">Select
									Attachment</label>
								<input name="event_file"
									id="event_file" type="file" accept="image/*"
    ...
    <script>
		...
		function saveEvent(){
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/lct/saveEvent",
				data : formData,
