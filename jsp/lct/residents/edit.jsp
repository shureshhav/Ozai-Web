										...
										<div class="row">
											...
											<form id="tenant-form" method="get" role="form">
												<div class="row pt-3">
													...
													<div class="col-md-6 form-actions text-center">
														<div class="card-body">
															<button type="submit" id="send1" class="btn btn-success">Move out</button>
														</div>
													</div>
												</div>
														...
														<div class="col-md-6 col-6 col-sm-12 col-12">
															<div class="mb-3 ">
																<label class="control-label">Property</label> <input
																	type="text" name="property" id="property" readonly
																	class="form-control" value="${details.property.name }" />
															</div>
														</div>
														<!--/span-->
														<div class="col-md-6 col-6 col-sm-12 col-12">
														...
														<div class="col-md-6 col-6 col-sm-12 col-12">
															<div class="mb-3 ">
																...
																<input
																	...
																	class="form-control" value="${details.user.language }" />
															</div>
														</div>
														<div class="col-md-6 col-6 col-sm-12 col-12">
															<div class="mb-3 ">
																...
																<input
																	type="text" name="food_preferences" id="food_preferences"
																	class="form-control" value="${details.user.food_preferences }" />
															</div>
														</div>
														<!--/span-->
	...
	<script>
		function updateTenant() {
			...
			$
					.ajax({
						type : "GET",
						url : "${pageContext.request.contextPath}/lct/residents/update-resident",
						data : formData,
						...
						success : function(data) {
							...
							if (data == 'success') {
								$('#onSuccess').click();
								window.location.href = '${pageContext.request.contextPath}/lct/residents/list';
							} else if (data == 'failed') {
								$('#errorMsg').click();
							}
							$("#send").button('reset');
		...
		function moveoutTenant() {
			...
			$
					.ajax({
						type : "GET",
						url : "${pageContext.request.contextPath}/lct/residents/move-out",
						data : formData,
						//contentType: "text/json; charset=utf-8",
						//dataType: "json",
						timeout : 100000,
