			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 text-center">
						<h5 class="text-dark fw-bold">PAID RENTS</h5>
					</div>
				...
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="alert">
							<div class="row m-0">
								<form id="month-form"
									action="<%=request.getContextPath()%>/lct/residents/month-property/paid-rents"
									role="form" method="post">
									<div class="row m-0">
										<div class="col-5">
											<label class="col-12">Month</label> <input type="month"
												name="month" id="month"
												style="width: 100%; height: auto; line-height: 2.5 !important;"
												class="form-select" required />
										</div>
										<div class="col-5">
											<label class="col-12">Property</label> <select
