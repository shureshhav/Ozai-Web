              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="justify-content-end">
                  	...
                  	<form action="<%=request.getContextPath() %>/lct/addUserAsResidentAction" 
						...
						<div class="col-md-6 mb-3">
							<div class="form-group">
								...
								<input type="text" name="room" id="room" required
									class="form-control"
									placeholder="" data-rule="minlen:2"
									data-msg="Please enter your least 2 chars">
								<div class="validate"></div>
								<small>*Ex: G5 or 103 or 208</small>
							</div>
						</div>
						<div class="col-md-6 mb-3">
							<div class="form-group">
