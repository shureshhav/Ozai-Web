...
<body>
										...
										<div class="row">
											...
											<div class="form-group">
												<div class="mb-3 controls">
													...
													<input minlength="3" class="form-control" type="text"
											...
											<div class="form-group">
												<div class="mb-3 controls">
													...
													<select id="country" name="country" 
														required class="form-control form-select"></select>
												</div>
											</div>
											<div class="form-group">
												<div class="mb-3 controls">
											...
											<input type="hidden" name="status" id="status" value="OPEN" required />											
											<div class="form-group">
												<div class="mb-3 controls">
													<label class="control-label">No of Rooms</label>
													<input
														class="form-control" type="text" name="rooms"
														id="rooms" required />
												</div>
											</div>
										</div>
	...
	<script>
		...
		function saveProperty() {
			var formData = $("#property-form").serialize();
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/lct/addProperty",
				data : formData,
