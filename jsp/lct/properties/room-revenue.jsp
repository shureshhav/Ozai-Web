        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="text-center">
              <h5 style="font-weight: 800; color: #000;">ROOM WISE REVENUE</h5>
            </div>
              ...
              <div class="">
                <div class="border-bottom title-part-padding text-end">
                  <a class="btn btn-dark btn-sm"
                  	href="<%=request.getContextPath() %>/lct/properties/property-revenue"><i class="fa fa-rupee-sign"></i> VIEW PROPERTY WISE REVENUE</a>
                </div>
                <div class="card-body">
						...
						<table class="table table-sm mb-0 v-middle" style="width: 100%;" id="beds">
							...
							<tbody>
                    			<c:forEach items="${revenues}" var="revenue" varStatus="sno">
									<tr>
										<td class="text-dark">${revenue.room }</td>
										<td style="font-weight: 500; ">${revenue.count }</td>
										<td style="font-weight: 500; ">${revenue.sharing - revenue.count }</td>
										<td style="font-weight: 700; border-left: 1px solid BLUE; border-right: 1px solid BLUE;">
											<c:choose>
												<c:when test="${empty revenue.total_rent }">
													0
												</c:when>
												<c:otherwise>
													${revenue.total_rent }
							...
							<tfoot>
								<tr>
									<th class="text-end text-muted" colspan="3">Total revenue</th>
