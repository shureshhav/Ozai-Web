              ...
              <div class="">
                <div class="border-bottom title-part-padding text-end">
                  <a class="btn btn-dark btn-sm"
                  	href="<%=request.getContextPath() %>/lct/properties/beds-list"><i class="fa fa-bed"></i> VIEW BEDS</a>
                </div>
                <div class="border-bottom title-part-padding text-end">
						...
						<table class="table table-sm mb-0 v-middle" style="width: 100%;" id="beds">
							...
							<tbody>
                    			<c:forEach items="${beds}" var="bed" varStatus="sno">
									<tr>
										<td class="text-dark">
											<a href="<%=request.getContextPath() %>/lct/properties/room-revenue/${bed.pg_id }">
												${bed.property }</a></td>
