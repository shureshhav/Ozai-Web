...
<title>Maintenance | Ozai Admin Dashboard</title>
<link rel="canonical"
						...
						<div id="note-full-container" class="note-has-grid row">
							<div class="col-md-4 single-note-item all-category">
								<div class="card card-body">
									...
									<p class="note-date fs-2 text-muted">11 Jan 2023</p>
									<div class="note-content">
										<p class="note-inner-content text-muted"
											data-noteContent="Blandit tempus porttitor aasfs. Integer posuere erat a ante venenatis.">
											Replaced regular cots with bunk beds across all the properties.</p>
									</div>
									<!-- <div class="d-flex align-items-center">
										...
										<div class="ms-auto">
											<div class="category-selector btn-group">
												<a
													class="nav-link dropdown-toggle category-dropdown
                            						label-group p-0"
												...
												<div
                            						...
                            						category-menu">
													<a
														class="note-business badge-group-item badge-business
							                              dropdown-item position-relative category-business
							                              text-success d-flex align-items-center"
														href="javascript:void(0);"><i
														class="ri-checkbox-blank-circle-line me-1"></i>Business</a> <a
														class="note-social badge-group-item badge-social
							                              dropdown-item position-relative category-social text-info
							                              d-flex align-items-center"
														href="javascript:void(0);"><i
														class="ri-checkbox-blank-circle-line me-1"></i> Social</a> <a
														class="note-important badge-group-item badge-important
							...
							<div
								class="col-md-4 single-note-item all-category note-important">
								<div class="card card-body">
									<span class="side-stick"></span>
									<h5 class="note-title text-truncate w-75 mb-0"
									...
									<p class="note-date fs-2 text-muted">01 Feb 2023</p>
									<div class="note-content">
										<p class="note-inner-content text-muted"
											data-noteContent="Blandit tempus porttitor aasfs. Integer posuere erat a ante venenatis.">
											Three more Internet lines have been added in Megan for 3rd and 4th floors.</p>
									</div>
									<!-- <div class="d-flex align-items-center">
										<a href="javascript:void(0)" class="link me-1"><i
											class="ri-star-line fs-5 favourite-note"></i></a> <a
												...
												<div
													...
													<a
														class="note-business badge-group-item badge-business
							                              ...
							                              category-business text-success
							                              d-flex align-items-center"
														href="javascript:void(0);"><i
														class="ri-checkbox-blank-circle-line me-1"></i>Business</a> <a
														class="note-social badge-group-item badge-social
							                              dropdown-item position-relative category-social
							                              text-info d-flex align-items-center"
														href="javascript:void(0);"><i
														class="ri-checkbox-blank-circle-line me-1"></i> Social</a> <a
														class="note-important badge-group-item badge-important
							                              dropdown-item position-relative
							                              category-important text-danger
							                              d-flex align-items-center"
														href="javascript:void(0);"><i
														class="ri-checkbox-blank-circle-line me-1"></i> Important</a>
												</div>
