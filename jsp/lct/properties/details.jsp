							...
							<div class="card-body">
								<div class="justify-content-end">
									...
									<div class="row card-body">
										<a href="<%=request.getContextPath() %>/lct/properties/room-revenue/${propertyDetails.id }"
									...
									<div class="row">
										<div class="col-6">
											<a
												href="<%=request.getContextPath()%>/lct/properties/add-room/${propertyDetails.id }"
										...
										<div class="col-6">
											<a
												href="<%=request.getContextPath()%>/lct/properties/rooms-list/${propertyDetails.id }"
									...
									<div class="row card-body">
										<a href="<%=request.getContextPath() %>/lct/properties/beds-list/${propertyDetails.id }"
