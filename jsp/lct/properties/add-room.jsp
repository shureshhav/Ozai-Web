...
<body>
			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 text-center">
						<h5 class="text-dark fw-bold">ADD ROOM</h5>
					</div>
				</div>
			</div>
			<!-- ============================================================== -->
					...
					<div class="col-12">
						<div class="row">
							<div class="card card-body bg-primary text-white">
								Recently added : 
								<c:forEach items="${rooms }" var="room" begin="1" end="3">
									${room.room_no },
								</c:forEach>...
							</div>
							<div class="card">
											...
											<div class="col-md-12">
												<div class="mb-3">
													...
													<input class="form-control" type="text" 
														name="room_no" id="room_no" required />
													<small>Ex: G1 or G12 or 109</small>
												</div>
											</div>
											<!--/span-->
											<div class="col-md-12">
											...
											<div class="row">
												...
												<div class="col-6 border-right">
													<div class="mb-3">
								                        ...
								                        <input
								                          type="radio" id="customRadio1" required
								                          name="ac" class="form-check-input" value="AC" />
								                        <label class="form-check-label" for="customRadio1">AC</label>
								                      </div>
								                      <div class="custom-control custom-radio">
								                        <input
								                          type="radio" id="customRadio2" required
								                          name="ac" class="form-check-input" value="Non-AC" />
												...
												<div class="col-6">
													<div class="mb-3">
								                        ...
								                        <input
								                          type="radio" id="customRadio1" required
								                          name="ventilated" class="form-check-input" value="YES" />
								                        <label class="form-check-label" for="customRadio1">Ventilated</label>
								                      </div>
								                      <div class="custom-control custom-radio">
								                        <input
								                          type="radio" id="customRadio2" required
								                          name="ventilated" class="form-check-input" value="NO" />
								                        <label class="form-check-label" for="customRadio2"
								                          >Non Ventilated</label>
								                      </div>
													</div>
												</div>
											</div>
	...
	<script>
		...
		function saveRoom() {
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/lct/addRoom",
				data : formData,
