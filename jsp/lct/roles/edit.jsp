  ...
  <body>
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 text-center">
              <h5 class="text-dark fw-bold">ADMIN ROLE</h5>
            </div>
			                  	...
			                  	<form action="#" method="get" role="form"
									id="user-form">
				                  	<div class="row">
										...
										<input type="hidden" name="client_code" id="client_code" value="${admin.client_code }" />
										<input type="hidden" name="client" id="client" value="${admin.client }" />
									</div>
    ...
    <script>
	    function updateTenant() {
			...
			$.ajax({
				type : "GET",
				url : "${pageContext.request.contextPath}/lct/roles/update-role",
				data : formData,
				...
				success : function(data) {
					...
					if (data == 'success') {
						$('#onSuccess').click();
						window.location.href = '${pageContext.request.contextPath}/lct/roles/list';
					} else if (data == 'failed') {
						$('#errorMsg').click();
					} 
					$("#send").button('reset');
