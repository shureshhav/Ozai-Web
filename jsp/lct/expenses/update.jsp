            ...
            <div class="">
              <div class="card">
			           					...
			           					<tr>
			           						<td>
			           							<button
							                        ...
							                        data-bs-target="#bs-example-modal-xlg${payment.id }"><i class="ri-attachment-2"></i></button>
                 													<div
								                        class="modal fade"
								                        ...
								                        <div class="modal-dialog modal-xl">
								                          <div class="modal-content">
								                            ...
								                            <iframe src="https://ozailiving.com/uploaded_files/DOC/PAYMENTS/${payment.screen_shot }"
			           						...
			           						<td>${payment.amount_tobe_paid }</td>
                ...
                <c:if test="${finance.status == 'Due' }">
                	...
                	<div class="row">
		                <form action="<%=request.getContextPath() %>/lct/addPaymentDetails" id="payment-form"
		                	method="post" modelAttribute="payment"  enctype="multipart/form-data">
		                  <div class="">
		                    <div class="card-body ">
			                	<div class="align-content-center text-center">
			                		<button class="btn btn-light-danger text-danger">Bank Identifier : ${finance.vendor.bank_identifier }</button>
			                	</div>
		                    </div>
		                    <div class="card-body">
		                      <!--/row-->
		                      <div class="row">
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label 
		                            	col-md-3">Expense Code</label>
		                            <div class="col-md-9">
		                              <input type="text" name="expense_id" id="expense_id"
		                                class="form-control" value="${finance.id }" />
		                            </div>
		                          </div>
		                        </div>
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label 
		                            	col-md-3">Invoice Amount</label>
		                            <div class="col-md-9">
		                              <input type="text" name="invoice_amount" id="invoice_amount"
		                                class="form-control" value="${finance.invoice_amount }" />
		                            </div>
		                          </div>
		                        </div>
		                        <!--/span-->
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            ...
		                            >
		                            <div class="col-md-9">
		                              <input type="text" name="gst_amount" value="${finance.gst_amount }" id="gst_amount"
		                        ...
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label 
		                            	col-md-3">Applicable TDS</label>
		                            <div class="col-md-9">
		                              <input type="text" name="applicable_tds" id="applicable_tds" value="${finance.vendor.applicable_tds }"
		                              	required class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                        ...
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label col-md-3"
		                              >TDS Amount</label>
		                            <div class="col-md-9">
		                              <input type="text" name="tds_amount" id="tds_amount" value="${tdsAmount }" required class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                      </div>
		                      <div class="row">
		                        ...
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            ...
		                            <div class="col-md-9">
		                              <input type="text" name="amount_tobe_paid" value="${totalAmount }" id="amount_tobe_paid" class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                        ...
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label col-md-3"
		                              >Total Amount Cleared</label>
		                            <div class="col-md-9">
		                              <input type="text" name="amount_cleared" id="amount_cleared" value="${totalAmountPaid }" required class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                        <!--/span-->
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            ...
		                            >
		                            <div class="col-md-9">
		                              <input type="text" name="pending_amount" id="pending_amount" value="${pendingAmount }" required class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                        ...
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            ...
		                            >
		                            <div class="col-md-9">
		                              <input type="date" name="payemnt_date" id="payemnt_date"
		                              	required class="form-control" value="${today }" />
		                            </div>
		                          </div>
		                        </div>
		                      </div>
		                          ...
		                          <div class="mb-3 row">
		                            ...
		                            <div class="col-md-9">
		                              <input type="text" name="amount_paid" id="amount_paid"
		                              	required class="form-control" value="${pendingAmount }" />
		                            </div>
		                          </div>
		                        </div>
		                      </div>
		                      <!--/row-->
		                      <div class="row">
								<input type="hidden" name="no" id="no" value="${finance.id }" />
		                        <!--/span-->
		                        <div class="col-md-12">
		                          <div class="mb-3 row">
		                            <label class="control-label col-md-3"
		                              >Txn Reference No</label
		                            >
		                            <div class="col-md-9">
		                              <input type="text" name="txn_ref_no" id="txn_ref_no" required class="form-control" />
		                            </div>
		                          </div>
		                        </div>
		                        <!--/span-->
		                        ...
		                        <div class="col-md-12">
									<div class="mb-3 row">
										<label class="control-label col-md-3">Select File Attachment</label>
		                            <div class="col-md-9">
										<input name="payment_file" id="payment_file" type="file" accept="" class="form-control" onchange="readURL(this)" required />
