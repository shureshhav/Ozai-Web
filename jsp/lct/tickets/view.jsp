	                    	...
	                    	<form action="#" method="get" role="form"
								id="user-form">
			                  	<div class="row">			                  		
			                        <div class="col-md-12 col-12">
			                        	<div class="mb-3">
					                  		<select id="status" required
												name="status" class="btn btn-outline-dark d-block w-100">
			                        ...
			                        <div class="col-md-12 col-12">
			                          <div class="mb-3">
										<textarea name="comments" id="comments" class="form-control" required><c:if test="${not empty ticket.comments }">${ticket.comments }</c:if></textarea>
			                          </div>
			                        </div>
					...
					<div class="row">
						<div class="card" style="border-radius: 20px;">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-6">
										<p style="font-weight: 800; color: #000;">Room : ${ticket.details.room.room_no }</p>
									</div>
									<div class="col-6">
										<p style="font-weight: 800; color: #000;">Camp : ${ticket.details.property.name }</p>														
									</div>
								</div>
								<p>${ticket.summary }</p>
