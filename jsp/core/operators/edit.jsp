								...
								<div class="card">
									<div class="card-body">
										<div class="card-header bg-info">
											<h4 class="card-title text-white">Edit Details</h4>
										</div>
										<div class="card-body">
											<div class="justify-content-end">
												...
												<form action="#" method="get" role="form" id="user-form">
													<div class="row">
														...
														<div class="col-md-6 col-6 col-sm-12 col-12">
															<div class="mb-3 ">
																<label class="control-label">Entity</label> <input
																	type="text" name="client" id="client" readonly
																	class="form-control" value="${admin.client }" />
															</div>
														</div>
														<!--/span-->
														<div class="col-md-6 col-6 col-sm-12 col-12">
														...
														<input type="hidden" name="client_code" id="client_code"
															value="${admin.client_code }" />
														<input type="hidden" name="access_level" id="access_level"
