			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="row align-self-center">
						<h4 class="page-title" style="font-weight: 900;">ORDER</h4>
					</div>
				</div>
			</div>
			<!-- ============================================================== -->
									...
									<div class="row">
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Groceries">
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Vegetables">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Dairy">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Poultry">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Food">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Electrical">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Electronics">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Furniture">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Security">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/CCTV">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Laundry">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Water">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Carpenter">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Kitchen Equipments">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Lift Service">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3 chooseFrom">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Man Power">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Marketing">
													<img style="height: 30px;"
										...
										<div class="col-sm-4 col-4 mb-3">
											<div class="text-center">
												<a href="<%=request.getContextPath() %>/core/orders/create/Software">
													<img style="height: 30px;"
