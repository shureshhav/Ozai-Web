...
<title>Show your talent | High Quality coliving spaces</title>
<meta content="Showcase your talent at Tikaana and get recognised." name="description">
<meta content="showcase talent, talent showcase, talent discovery, coliving space, Hyderabad, working professionals, students, hostels, pgs, all
amenities, ac, non ac, Bangalore, Chennai" name="keywords">
				...
				<div class="col-sm-12 section-t8" style="padding-top: 0px;">
					<div class="row">
						<div class="col-md-8">
							...
							<form action="<%=request.getContextPath()%>/mobile/submit-talent"
						...
						<div class="col-md-4">
							<br>
							<a href="<%=request.getContextPath() %>/mobile/talent/entries"
