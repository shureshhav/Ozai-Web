...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Loan Application | Tikaana</title>
    <link
      rel="canonical"
        ...
        <div class="container-fluid">
          ...
          <div class="card" style="display: none;" id="successScreen">
			...
			<div class="card-title text-center">
				<p>YOUR LOAN APPLICATION IS SUCCESSFULL.</p>
			</div>
			<div class="card-text">
	                    	...
	                    	<c:if test="${empty User }">
	                    		...
	                    		<div class="col-md-12 mb-3"><br>
									<div class="col-md-4 col-xl-2 
										...
										<a href="<%=request.getContextPath() %>/mobile/login" class="card bg-success text-white w-100 card-hover">
											<div class="card-body">
