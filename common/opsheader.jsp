            ...
            <div class="navbar-brand">
              <a href="index.html" class="logo">
                ...
                <b class="logo-icon">
                  ...
                  <!-- Dark Logo icon -->
                  <img
                    src="<%=request.getContextPath()%>/assets/img/logo-1.png"
                    alt="homepage"
                    class="dark-logo"
                  />
                  <!-- Light Logo icon -->
	            ...
	            <c:if test="${not empty OpsUser }">
					<a
						...
						aria-expanded="false"> <img
							...
							<span class="ms-1 font-weight-medium d-none d-sm-inline-block">${OpsUser.name }
						...
						<div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
							...
							<div class="d-flex no-block align-items-center p-3 bg-primary text-white mb-2">
								...
								<div class="ms-2">
									<h4 class="mb-0 text-white">${OpsUser.name }</h4>
							...
							<!-- <a class="dropdown-item" href="#"><i
								...
								Account Setting</a> -->
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<%=request.getContextPath()%>/opslogout"><i
